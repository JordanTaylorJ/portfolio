    ...
    return(
        ...
        <tbody>
            <tr className="border-b">
                ...
                <td className='text-right text-sm'>03/2023</td>
                <td className='text-right'>Colorado Springs, CO</td>
            </tr>
            <tr className="border-b">
                <td>Staff Accountant - Bradshaw & Associates, PLLC</td>
                <td className='text-right text-sm'>06/2021 - 05/2022</td>
                <td className='text-right'>Colorado Springs, CO</td>
            </tr>
            <tr className="border-b">
                <td>Income Auditor - The Broadmoor</td>
                <td className='text-right text-sm'>10/2020 - 02/2021</td>
                <td className='text-right'>Colorado Springs, CO</td>
            </tr>
            <tr className="border-b">
                <td>Executive Assistant - Papillon Helicopters</td>
                <td className='text-right text-sm'>10/2019 - 05/2020</td>
                <td className='text-right'>Tusayan, AZ</td>
            </tr>
            <tr className="border-b">
                <td>Instructor - Avid4 Aventure</td>
                <td className='text-right text-sm'>06/2019 - 09/2019</td>
