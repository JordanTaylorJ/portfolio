    ...
    <div id='About' className="grid min-h-screen md:mt-20 p-6 md:p-24 gap-12 lg:gap-24 md:grid-cols-3 items-center" >
        <div className='md:col-span-2 bg-sage px-10 py-16 self-center' >
            ...
            <a href='./resume_jordanjoseph.pdf' download='resume_jordanjoseph'>
                <button className='justify-right outline outline-offset-2 rounded hover:text-white'>download Resume</button>
            </a>
        </div>
...
/*
    <div className='container min-h-screen relative bg-brown bg-opacity-75 md:bg-opacity-0 grid '>
        ...
        <img className='md:absolute place-self-center block md:top-80 md:right-24 w-44 md:w-72 lg:w-80 grayscale' src='./art.jpeg'/>
        <img className='md:absolute place-self-center block md:top-44 md:right-64 w-60 md:-96 lg:w-2/5 shadow-lg' src='./beach.jpeg'/>
        <img className='md:absolute place-self-center md:top-12 md:left-24 w-44 md:w-60 lg:w-96 grayscale' src='./shav.jpg'/>
    </div>
*/