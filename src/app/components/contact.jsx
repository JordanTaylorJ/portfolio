    ...
    return(
        <div className="container flex min-h-screen p-24 gap-24 column-2" >
            <div className='bg-greenblue px-10 py-14 self-center' >
                <h1 className='text-3xl pb-8 text-white pl-5' >Get In Touch</h1>
                <p className='text-center'>
                I'm in search of a full-stack, frontend, or backend programming opportunity. I'm also open to collaborative projects.
                </p>
                <br></br>
